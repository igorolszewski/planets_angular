...
(function(){
    /*
     * Creating List controller and attaching it to the main planetFacts module
     */
    angular
        .module("planetFacts")
    ...
    function ListController(quizMetrics, DataService){
        ...
        vm.data = DataService.planetsData; // Controller reference to the planet info created in the factory
        vm.activePlanet = {}; // will be used in the view to hold the data of currently active planet
        vm.changeActivePlanet = changeActivePlanet; // reference to a named function below
        ...
        function changeActivePlanet(index){
            // simple function to attach the data of the planet clicked on to 
            // the active planet object
